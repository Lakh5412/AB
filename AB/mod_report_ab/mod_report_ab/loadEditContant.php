    ...
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb" id="boxSubSelect">
            <select name="inputFbID" id="inputFbID" class="formSelectContantTb select2">
              ...
              ?>
                <option value="<?php echo $row_fbid ?>" <?php if ($valFbid == $row_fbid) { ?> selected="selected" <?php  } ?>><?php echo $valNamecShow ?></option>
              <?php  } ?>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb" id="boxSubSelect">
            <select name="inputDvID" id="inputDvID" class="formSelectContantTb select2">
              ...
              while ($row_fb = wewebFetchArrayDB($coreLanguageSQL, $query_fb)) {
                ...
                $valNamecShow = $row_fb[1];
              ?>
                <option value="<?php echo $row_dvid ?>" <?php if ($valDvid == $row_dvid) { ?> selected="selected" <?php  } ?>><?php echo $valNamecShow ?></option>
              <?php  } ?>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb" id="boxSubSelect">
            <select name="inputStatusID" id="inputStatusID" class="formSelectContantTb select2">
              ...
              while ($row_fb = wewebFetchArrayDB($coreLanguageSQL, $query_fb)) {
                ...
                $valNamecShow = $row_fb[1];
              ?>
                <option value="<?php echo $row_statusid ?>" <?php if ($valStatusid == $row_statusid) { ?> selected="selected" <?php  } ?>><?php echo $valNamecShow ?></option>
              <?php  } ?>
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><textarea name="inputDetail" id="inputDetail" cols="45" rows="5" class="formTextareaContantTb"><?php echo $valDetail ?></textarea></td>
        </tr>
      </table>
