...
$valUserGroupid = $_SESSION[$valSiteManage . "core_session_groupid"];

$valUserID = 0;
if ($_SESSION[$valSiteManage . "core_session_storeid"] != 0) {
    $valUserID = $_SESSION[$valSiteManage . "core_session_storeid"];
}
if ($_SESSION[$valSiteManage . "core_session_sell"]) {
    $valArrSell = $_SESSION[$valSiteManage . "core_session_sell"];
}
                ...
                <tr>
                    ...
                    <td class="selectSearch2">
                        <select name="inputSellID" id="inputSellID" onchange="document.myForm.submit();" class="formSelectSearchStyle">
                            ...
                            if ($_REQUEST['masterkey'] == "HA") {
                                $sql_sell_search .= " AND " . $mod_tb_data . "_masterkey = 'HA' ";
                            } elseif ($_REQUEST['masterkey'] == "HB") {
                                $sql_sell_search .= " AND " . $mod_tb_data . "_masterkey = 'HB' ";
                            }
                ...
                <table width="15%" border="0" cellspacing="0" cellpadding="0" align="left" class="tbBoxListwBorder">
                    ...
                    while ($day < $countDay + 1) {
                        ...
                        if ($day <= $countDayNow +1) {  
                            $apply = countRegister($year, $month, $day, $dvid, $valArrSell);
                            $deposit = countDeposit($year, $month, $day, $dvid, $valArrSell);     
                        }else{
                            $apply = 0;
                            $deposit = 0;
                        }                       
